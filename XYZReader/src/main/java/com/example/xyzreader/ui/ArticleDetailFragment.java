...
//                            int color = palette.getVibrantColor(getActivity().getResources().getColor(R.color.muted_red));
...
////
////                                Palette palette = Palette.from(bitmap).generate();
////                                int color = palette.getVibrantColor(palette.getMutedColor(palette.getDominantColor(getActivity().getResources().getColor(R.color.muted_red))));
////                                int darkColor = makeColorDarker(color);
////
////                                mCollapsingToolbarLayout.setStatusBarScrimColor(darkColor);
////                                mCollapsingToolbarLayout.setContentScrimColor(color);
